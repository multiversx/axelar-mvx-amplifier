...
pub fn messages_mvx() -> Vec<Message> {
    vec![Message {
        cc_id: CrossChainId {
            source_chain: "ganache-1".parse().unwrap(),
            message_id: "0xff822c88807859ff226b58e24f24974a70f04b9442501ae38fd665b3c68f3834-0"
                .parse()
                .unwrap(),
        },
        source_address: "0x52444f1835Adc02086c37Cb226561605e2E1699b"
            .parse()
            .unwrap(),
        destination_address: "erd1qqqqqqqqqqqqqpgqd77fnev2sthnczp2lnfx0y5jdycynjfhzzgq6p3rax"
            .parse()
            .unwrap(),
        destination_chain: "multiversx-D".parse().unwrap(),
        payload_hash: HexBinary::from_hex(
            "8c3685dc41c2eca11426f8035742fb97ea9f14931152670a5703f18fe8b392f0",
        )
        .unwrap()
...
pub fn curr_verifier_set_ed25519() -> VerifierSet {
    ...
    verifier_set_from_pub_keys_ed25519(pub_keys)
}

pub fn verifier_set_from_pub_keys_ed25519(pub_keys: Vec<&str>) -> VerifierSet {
    let participants: Vec<(_, _)> = (0..pub_keys.len())
        .map(|i| {
            (
                Participant {
...
pub fn domain_separator_other() -> [u8; 32] {
    HexBinary::from_hex("209d8e45d084f6d3171d9e862bce4c3b17bf03ab71a687406c111f55b8dceb76")
        .unwrap()
        .to_array()
        .unwrap()
}
